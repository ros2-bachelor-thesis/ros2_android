...
namespace ros2_android
{
    namespace jni
    {
        ...
        jobject CreateSensorReading(JNIEnv *env, const SensorReadingData &data)
        {
            ...
            // Find constructor: SensorReading(List<Double>, String, SensorType, String?)
            jmethodID constructor = env->GetMethodID(
                sensorReadingClass, "<init>",
                "(Ljava/util/List;Ljava/lang/String;Lcom/github/mowerick/ros2/android/model/SensorType;Ljava/lang/String;)V");
            if (!constructor)
            {
            ...
            // Create the SensorReading object (statusMessage = null, frontend handles GPS status)
            jobject sensorReading = env->NewObject(
                sensorReadingClass, constructor,
                valuesList, unit, sensorTypeEnum, nullptr);
